...
status = True # False  # Boolean data type
...
# Data types: String(str), Integers (int), floats(float), boolean (bool)
...
# CTRL + C - copies the line that your cursor is on, you don't have to highlight
